...
class MySQL
{
	...
	private $db_host    = "devDC.db.9408179.hostedresource.com"; // server name
	private $db_user    = "devDC";          // user name
	private $db_pass    = "DrinkCap2014!";          // password
	private $db_dbname  = "devDC";          // database name
